...
export const GuardarPage = (props) => {
    const {client} = props;
    ...
    return (
        <div id="main-content">
            <form id="form" className="budget">
                ...
                <div>Guarde seu dinheiro para algo em mente.</div>

                <div id="budget">
                    <div className="budget-menu">
                        <div>
                            <button className="btn2" onClick={addBudget}><i className='bx bx-book-add'></i> Adicionar Quantidade</button>
                        </div>
                        <div>
    ...
    return (<div className="overlay">
        <div className="modal">
            <form onSubmit={onSubmit}>
                <h2 className="title">Guarde seu dinheiro</h2>
                ...
                <button type="submit" className="btn2">Guardar Saldo</button>
